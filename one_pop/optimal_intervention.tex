...
\begin{figure}
    \centering
    \subfigure[$\sigma=3$]{\label{sigma3}\includegraphics[width=0.49\textwidth]{sigma3.pdf}}
    \subfigure[$\sigma=1.5$]{\label{sigma15}\includegraphics[width=0.49\textwidth]{sigma15.pdf}}
...
%In this section we make use of Pontryagin's maximum principle \cite[Thm. 3.3.1]{speyer2010primer}
%to obtain necessary conditions for a solution of \eqref{eq:basic-problem}.
%We make the following assumptions (corresponding to \cite[Assumptions 3.2.2-3.2.4]{speyer2010primer}:
%\begin{enumerate}
%    \item the control $\sigma(t)$ is piecewise continuous;
%    \item the running cost $L$ is once continuously differentiable in $x$ and $y$ and is continuous in $t$;
%    \item the final cost $-\Sinf$ is once continuously differentiable in $x$ and $y$.
%\end{enumerate}
%The second assumption above will hold for all costs considered in this work, as will the third assumption
%(since the point $(x,y)=(1/\sigma_0,0)$ cannot be reached in finite time from $\dom$).
...
\begin{proof}
    ...
    %\cite[Corollary 4.1]{fleming2012deterministic} 
    ...
    %to convert the problem \eqref{eq:basic-problem}
    %into that of minimizing $H$ in \eqref{eq:ham} pointwise with respect to $\sigma$.  
    %On the interior of the set of admissible controls we have \eqref{eq:dldsig}, which leads to \eqref{eq:sigma-c2}.
\end{proof}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{twocontrols.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{threepaths.pdf}
...
\begin{figure}
    \centering
    \subfigure[Solution and control vs. time]{\label{fig:ex1-time}\includegraphics[width=0.65\textwidth]{example1_time.pdf}}
    \subfigure[Trajectory in phase space]{\label{fig:ex1-xy}\includegraphics[width=0.34\textwidth]{example1_xy.pdf}}
    \caption{Typical optimal solution.  Here $(x(0),y(0)) = (0.99,0.01)$, $\beta=0.3$, and $\gamma=0.1$.\label{fig:example1}}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{diff-time-opt.pdf}
...
\begin{figure}
    \centering
    \subfigure[Solution and control vs. time]{\label{fig:example_2-t}\includegraphics[width=0.65\textwidth]{example2_time.pdf}}
    \subfigure[Trajectory in phase space]{\label{fig:example_2-xy}\includegraphics[width=0.34\textwidth]{example2_xy.pdf}}
...
\begin{figure}
    \centering
    \subfigure[Solution (solid line) and control $\sigma(t)/\Rnot$ (dashed line) vs. time]{\label{fig:varying-c2}\includegraphics[width=0.65\textwidth]{varying_c2.pdf}}
    \subfigure[Trajectory in phase space]{\label{fig:varying-cs-xy}\includegraphics[width=0.34\textwidth]{varying_c2_xy.pdf}}
...
In both examples, the cost of control is scaled by $c_2=10^{-2}$.
In Figure \ref{fig:min_hosp_1}, a higher cost for hospital overflow is applied,
with $c_3=100$.  As might be expected, $y(t)$ is generally
...
\begin{figure}
    \centering
    \subfigure[Solution and control vs. time]{\label{fig:minhosp1-time}\includegraphics[width=0.65\textwidth]{min_hosp_1_t.pdf}}
    \subfigure[Trajectory in phase space]{\label{fig:minhosp1-xy}\includegraphics[width=0.34\textwidth]{min_hosp_1_xy.pdf}}
...
\begin{figure}
    \centering
    \subfigure[Solution and control vs. time]{\label{fig:minhosp2-time}\includegraphics[width=0.65\textwidth]{min_hosp_2_t.pdf}}
    \subfigure[Trajectory in phase space]{\label{fig:minhosp2-xy}\includegraphics[width=0.34\textwidth]{min_hosp_2_xy.pdf}}
...
\begin{figure}
    \centering
    \subfigure[Solution and control vs. time]{\label{fig:real_world_1-time}\includegraphics[width=0.65\textwidth]{real_world_1_t.pdf}}
    \subfigure[Trajectory in phase space]{\label{fig:real_world_1-xy}\includegraphics[width=0.34\textwidth]{real_world_1_xy.pdf}}
...
\begin{figure}
    \centering
    \subfigure[Solution and control vs. time]{\label{fig:real_world_2-time}\includegraphics[width=0.65\textwidth]{real_world_2_t.pdf}}
    \subfigure[Trajectory in phase space]{\label{fig:real_world_2-xy}\includegraphics[width=0.34\textwidth]{real_world_2_xy.pdf}}
    \caption{Optimal control for COVID-19 with $\Rnot=3.2$, $\gamma=0.1$,
...
\begin{figure}
    \centering
    \subfigure[Solution and control vs. time]{\label{fig:real_world_3-time}\includegraphics[width=0.65\textwidth]{real_world_3_t.pdf}}
    \subfigure[Trajectory in phase space]{\label{fig:real_world_3-xy}\includegraphics[width=0.34\textwidth]{real_world_3_xy.pdf}}
    \caption{Optimal control for COVID-19 with $\Rnot=3.2$, $\gamma=0.1$,
