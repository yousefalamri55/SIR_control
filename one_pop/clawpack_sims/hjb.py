...
def setup(outdir='./_output',solver_type='classic',mx=50,my=50,c2=0.,min_fac=0.):
...
def solve_hjb(beta=0.3, gamma=0.1, x0=0.99, y0=0.01, c2=1.e-2, c3=0., ymax=0.1, T=100, qmax=1., mx=100, my=100):
    sigma0 = beta/gamma
    min_fac = (1-qmax)*sigma0

    # Solve HJB PDE
    claw = setup(solver_type='sharpclaw',mx=mx,my=my,c2=c2,min_fac=min_fac)
    claw.tfinal = T
    #claw.verbosity = 0
    claw.run()
